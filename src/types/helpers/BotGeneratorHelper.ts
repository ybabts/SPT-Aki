...
import type { DurabilityLimitsHelper } from "../helpers/DurabilityLimitsHelper.ts";
...
import type { Item, Repairable, Upd } from "../models/eft/common/tables/IItem.ts";
import type { Grid, ITemplateItem } from "../models/eft/common/tables/ITemplateItem.ts";
import type { ItemAddedResult } from "../models/enums/ItemAddedResult.ts";
import type { IChooseRandomCompatibleModResult } from "../models/spt/bots/IChooseRandomCompatibleModResult.ts";
import type { EquipmentFilters, IBotConfig, IRandomisedResourceValues } from "../models/spt/config/IBotConfig.ts";
