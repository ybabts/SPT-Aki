...
import { ProfileTraderTemplate } from "../models/eft/common/tables/IProfileTemplate.d.ts";
import { ITraderAssort, ITraderBase, LoyaltyLevel } from "../models/eft/common/tables/ITrader.d.ts";
