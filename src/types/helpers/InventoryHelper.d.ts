...
import { Item, Upd } from "../models/eft/common/tables/IItem.d.ts";
import { IAddItemDirectRequest } from "../models/eft/inventory/IAddItemDirectRequest.d.ts";
import { AddItem } from "../models/eft/inventory/IAddItemRequestData.d.ts";
import { IAddItemsDirectRequest } from "../models/eft/inventory/IAddItemsDirectRequest.d.ts";
import { IAddItemTempObject } from "../models/eft/inventory/IAddItemTempObject.d.ts";
...
import { IInventoryConfig, RewardDetails } from "../models/spt/config/IInventoryConfig.d.ts";
