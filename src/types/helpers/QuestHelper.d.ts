...
import { Common, IQuestStatus } from "../models/eft/common/tables/IBotBase.d.ts";
import { Item } from "../models/eft/common/tables/IItem.d.ts";
import { IQuest, IQuestCondition, IQuestReward } from "../models/eft/common/tables/IQuest.d.ts";
