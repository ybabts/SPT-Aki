...
import type { Common, IQuestStatus } from "../models/eft/common/tables/IBotBase.ts";
import type { Item } from "../models/eft/common/tables/IItem.ts";
import type { IQuest, IQuestCondition, IQuestReward } from "../models/eft/common/tables/IQuest.ts";
