...
import type { ProfileTraderTemplate } from "../models/eft/common/tables/IProfileTemplate.ts";
import type { ITraderAssort, ITraderBase, LoyaltyLevel } from "../models/eft/common/tables/ITrader.ts";
