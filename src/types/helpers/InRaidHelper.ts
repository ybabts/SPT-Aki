...
import type { IPmcData, IPostRaidPmcData } from "../models/eft/common/IPmcData.ts";
import type { IQuestStatus, TraderInfo } from "../models/eft/common/tables/IBotBase.ts";
...
import type { ProfileHelper } from "./ProfileHelper.ts";
