...
import { Difficulty, IBotType } from "../models/eft/common/tables/IBotType.d.ts";
import { EquipmentFilters, IBotConfig, RandomisationDetails } from "../models/spt/config/IBotConfig.d.ts";
