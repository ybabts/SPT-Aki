...
import type { Item, Upd } from "../models/eft/common/tables/IItem.ts";
import type { IAddItemDirectRequest } from "../models/eft/inventory/IAddItemDirectRequest.ts";
import type { AddItem } from "../models/eft/inventory/IAddItemRequestData.ts";
import type { IAddItemsDirectRequest } from "../models/eft/inventory/IAddItemsDirectRequest.ts";
import type { IAddItemTempObject } from "../models/eft/inventory/IAddItemTempObject.ts";
...
import type { IInventoryConfig, RewardDetails } from "../models/spt/config/IInventoryConfig.ts";
