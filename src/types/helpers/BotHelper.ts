...
import type { Difficulty, IBotType } from "../models/eft/common/tables/IBotType.ts";
import type { EquipmentFilters, IBotConfig, RandomisationDetails } from "../models/spt/config/IBotConfig.ts";
