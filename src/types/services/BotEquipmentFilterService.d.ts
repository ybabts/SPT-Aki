...
import { EquipmentChances, Generation, GenerationData, IBotType, ModsChances } from "../models/eft/common/tables/IBotType.d.ts";
import { BotGenerationDetails } from "../models/spt/bots/BotGenerationDetails.d.ts";
import { EquipmentFilterDetails, EquipmentFilters, IAdjustmentDetails, IBotConfig, WeightingAdjustmentDetails } from "../models/spt/config/IBotConfig.d.ts";
