...
import type { IFenceLevel } from "../models/eft/common/IGlobals.ts";
import type { IPmcData } from "../models/eft/common/IPmcData.ts";
import type { Item, Repairable } from "../models/eft/common/tables/IItem.ts";
import type { ITemplateItem } from "../models/eft/common/tables/ITemplateItem.ts";
import type { IBarterScheme, ITraderAssort } from "../models/eft/common/tables/ITrader.ts";
import type { IItemDurabilityCurrentMax, ITraderConfig } from "../models/spt/config/ITraderConfig.ts";
import type { ICreateFenceAssortsResult } from "../models/spt/fence/ICreateFenceAssortsResult.ts";
import type { IFenceAssortGenerationValues, IGenerationAssortValues } from "../models/spt/fence/IFenceAssortGenerationValues.ts";
