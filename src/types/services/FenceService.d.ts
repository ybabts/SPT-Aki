...
import { IFenceLevel } from "../models/eft/common/IGlobals.d.ts";
import { IPmcData } from "../models/eft/common/IPmcData.d.ts";
import { Item, Repairable } from "../models/eft/common/tables/IItem.d.ts";
import { ITemplateItem } from "../models/eft/common/tables/ITemplateItem.d.ts";
import { IBarterScheme, ITraderAssort } from "../models/eft/common/tables/ITrader.d.ts";
import { IItemDurabilityCurrentMax, ITraderConfig } from "../models/spt/config/ITraderConfig.d.ts";
import { ICreateFenceAssortsResult } from "../models/spt/fence/ICreateFenceAssortsResult.d.ts";
import { IFenceAssortGenerationValues, IGenerationAssortValues } from "../models/spt/fence/IFenceAssortGenerationValues.d.ts";
