import type { Item, Upd } from "./IItem.ts";
import type { IPmcDataRepeatableQuest } from "./IRepeatableQuests.ts";
import type { IRagfairOffer } from "../../ragfair/IRagfairOffer.ts";
import type { BonusSkillType } from "../../../enums/BonusSkillType.ts";
import type { BonusType } from "../../../enums/BonusType.ts";
import type { HideoutAreas } from "../../../enums/HideoutAreas.ts";
import type { MemberCategory } from "../../../enums/MemberCategory.ts";
import type { QuestStatus } from "../../../enums/QuestStatus.ts";
