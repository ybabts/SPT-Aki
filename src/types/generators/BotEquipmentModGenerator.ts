...
import type { ProbabilityHelper } from "../helpers/ProbabilityHelper.ts";
...
import type { Mods, ModsChances } from "../models/eft/common/tables/IBotType.ts";
import type { Item } from "../models/eft/common/tables/IItem.ts";
import type { ITemplateItem, Slot } from "../models/eft/common/tables/ITemplateItem.ts";
import type { ModSpawn } from "../models/enums/ModSpawn.ts";
import type { IChooseRandomCompatibleModResult } from "../models/spt/bots/IChooseRandomCompatibleModResult.ts";
import type { EquipmentFilterDetails, EquipmentFilters, IBotConfig } from "../models/spt/config/IBotConfig.ts";
import type { ILogger } from "../models/spt/utils/ILogger.ts";
import type { ConfigServer } from "../servers/ConfigServer.ts";
import type { DatabaseServer } from "../servers/DatabaseServer.ts";
import type { BotEquipmentFilterService } from "../services/BotEquipmentFilterService.ts";
import type { BotEquipmentModPoolService } from "../services/BotEquipmentModPoolService.ts";
import type { BotModLimits, BotWeaponModLimitService } from "../services/BotWeaponModLimitService.ts";
...
import type { IGenerateEquipmentProperties } from "./BotInventoryGenerator.ts";
import type { IFilterPlateModsForSlotByLevelResult } from "./IFilterPlateModsForSlotByLevelResult.ts";
