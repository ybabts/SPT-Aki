...
import type { BotLootGenerator } from "../generators/BotLootGenerator.ts";
...
import type { Chances, Generation, IBotType, Inventory, Mods } from "../models/eft/common/tables/IBotType.ts";
import type { EquipmentSlots } from "../models/enums/EquipmentSlots.ts";
import type { EquipmentFilterDetails, EquipmentFilters, IBotConfig, RandomisationDetails } from "../models/spt/config/IBotConfig.ts";
