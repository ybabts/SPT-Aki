...
import { IQuestReward, IQuestRewards } from "../models/eft/common/tables/IQuest.d.ts";
import { ITemplateItem } from "../models/eft/common/tables/ITemplateItem.d.ts";
import { IBaseQuestConfig, IQuestConfig, IRepeatableQuestConfig } from "../models/spt/config/IQuestConfig.d.ts";
