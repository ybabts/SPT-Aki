...
import { ProbabilityHelper } from "../helpers/ProbabilityHelper.d.ts";
...
import { Mods, ModsChances } from "../models/eft/common/tables/IBotType.d.ts";
import { Item } from "../models/eft/common/tables/IItem.d.ts";
import { ITemplateItem, Slot } from "../models/eft/common/tables/ITemplateItem.d.ts";
import { ModSpawn } from "../models/enums/ModSpawn.d.ts";
import { IChooseRandomCompatibleModResult } from "../models/spt/bots/IChooseRandomCompatibleModResult.d.ts";
import { EquipmentFilterDetails, EquipmentFilters, IBotConfig } from "../models/spt/config/IBotConfig.d.ts";
...
import { BotModLimits, BotWeaponModLimitService } from "../services/BotWeaponModLimitService.d.ts";
...
import { IGenerateEquipmentProperties } from "./BotInventoryGenerator.d.ts";
import { IFilterPlateModsForSlotByLevelResult } from "./IFilterPlateModsForSlotByLevelResult.d.ts";
