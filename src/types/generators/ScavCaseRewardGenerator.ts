...
import type { IScavCaseConfig } from "../models/spt/config/IScavCaseConfig.ts";
import type { RewardCountAndPriceDetails, ScavCaseRewardCountsAndPrices } from "../models/spt/hideout/ScavCaseRewardCountsAndPrices.ts";
