...
import { IRagfairOffer, OfferRequirement } from "../models/eft/ragfair/IRagfairOffer.d.ts";
import { Dynamic, IArmorPlateBlacklistSettings, IRagfairConfig } from "../models/spt/config/IRagfairConfig.d.ts";
