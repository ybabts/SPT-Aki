...
import { IBotType, Inventory, ModsChances } from "../models/eft/common/tables/IBotType.d.ts";
...
import { IItemSpawnLimitSettings } from "../models/spt/bots/IItemSpawnLimitSettings.d.ts";
