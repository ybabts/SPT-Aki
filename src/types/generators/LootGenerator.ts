...
import type { ISealedAirdropContainerSettings, RewardDetails } from "../models/spt/config/IInventoryConfig.ts";
import type { LootItem } from "../models/spt/services/LootItem.ts";
