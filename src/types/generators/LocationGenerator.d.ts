...
import { IContainerMinMax, IStaticContainer } from "../models/eft/common/ILocation.d.ts";
import { ILocationBase } from "../models/eft/common/ILocationBase.d.ts";
import { ILooseLoot, Spawnpoint, SpawnpointTemplate, SpawnpointsForced } from "../models/eft/common/ILooseLoot.d.ts";
import { Item } from "../models/eft/common/tables/IItem.d.ts";
import { IStaticAmmoDetails, IStaticContainerData, IStaticForcedProps, IStaticLootDetails } from "../models/eft/common/tables/ILootBase.d.ts";
